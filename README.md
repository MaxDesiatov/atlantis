...
3. Open macOS [Proxyman](https://proxyman.io) (or [download the latest here](https://proxyman.io/release/osx/Proxyman_latest.dmg)) ([Github](https://github.com/ProxymanApp/Proxyman))(2.11.0+)
